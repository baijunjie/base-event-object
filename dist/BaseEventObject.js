...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(63), __webpack_require__(60), __webpack_require__(57), __webpack_require__(64), __webpack_require__(58), __webpack_require__(65), __webpack_require__(59), __webpack_require__(61), __webpack_require__(62)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    } else if (typeof exports !== "undefined") {
        factory(module, exports, require('babel-runtime/helpers/defineProperty'), require('babel-runtime/core-js/object/values'), require('babel-runtime/core-js/get-iterator'), require('babel-runtime/helpers/toConsumableArray'), require('babel-runtime/core-js/map'), require('babel-runtime/helpers/typeof'), require('babel-runtime/core-js/object/define-properties'), require('babel-runtime/helpers/classCallCheck'), require('babel-runtime/helpers/createClass'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod, mod.exports, global.defineProperty, global.values, global.getIterator, global.toConsumableArray, global.map, global._typeof, global.defineProperties, global.classCallCheck, global.createClass);
        global.index = mod.exports;
    }
})(this, function (module, exports, _defineProperty2, _values, _getIterator2, _toConsumableArray2, _map, _typeof2, _defineProperties, _classCallCheck2, _createClass2) {
    'use strict';
    ...
    var _class = function () {
        ...
        function _class(events) {
            ...
            } else if ((typeof events === 'undefined' ? 'undefined' : (0, _typeof3.default)(events)) === 'object') {
                options = events;
            } else {
    ...
    function _on(type, callback) {
        ...
        if (this._onceEvents[type]) {
            callback.call.apply(callback, [this, { type: type }].concat((0, _toConsumableArray3.default)(this._onceEvents[type])));
            return;
        }
    ...
    function _off(type, callback) {
        var typeStr = typeof type === 'undefined' ? 'undefined' : (0, _typeof3.default)(type);
        ...
        if (typeStr === 'undefined') {
            ...
            try {
                for (var _iterator = (0, _getIterator3.default)((0, _values2.default)(this._callbackMap)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (this._callbackMap[type]) {
                callbackMap = (0, _defineProperty3.default)({}, type, this._callbackMap[type]);
            } else {
                return;
            }
        ...
        try {
            for (var _iterator2 = (0, _getIterator3.default)((0, _values2.default)(callbackMap)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
$export($export.S + $export.F * !__webpack_require__(2), 'Object', { defineProperties: __webpack_require__(49) });
